...
class Dataset(Dataset):
    def __init__(
        self, filename, preprocess_config, train_config, sort=False, drop_last=False, test=False
    ):
    ...
    def __getitem__(self, idx):
        ...
        while(1):
            ...
            # print("Wav: ", wav.shape, "Frames: ", len(frames), "\tVisual emb shape: ", visual_emb.shape, "\tMel shape: ", mel.shape, "\tMel on-the-fly shape: ", mel_spectrogram.shape)
            ...
            # print("After: ", mel_spectrogram.shape)
