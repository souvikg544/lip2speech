...
def get_vidlist(pkl_file):
	test = pickle.load(open(pkl_file, 'rb'))
	test_vids = {}
	for x in test:
		x = x[:x.rfind('/')]
...
if __name__ == '__main__':
	pkl_file = 'logs/filenames_test.pkl'
	videos = get_vidlist(pkl_file)

	RESULTS_ROOT = sys.argv[1] #'/scratch/cvit/rudra/lrs2_bigger_test_set_results/'
